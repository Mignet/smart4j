...
import com.v5ent.core.util.MD5Utils;
...
public class SSDBManager {
	...
	public static void main(String[] args) {
		//String key = MD5Utils.getMd5ByFile(new File("src/main/java/com/v5ent/plugin/ssdb/ssdb.properties"));
