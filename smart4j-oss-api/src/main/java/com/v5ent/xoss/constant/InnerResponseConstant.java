...
public class InnerResponseConstant {
	 ...
	 */
	public static final BaseResponse ORG_SECRET_INVALID = new BaseResponse("ORG_SECRET_INVALID","机构对应的密钥配置不正确，请【框架科技】配合检查请求参数是否正确或者是否配置该密钥");
	/**
	 * 密钥查询为空或秘钥处于关闭状态，请检查配置该密钥是否正确
	 */
	public static final BaseResponse ORG_SECRET_CLOSE_INVALID = new BaseResponse("ORG_SECRET_CLOSE_INVALID","密钥查询为空或秘钥处于关闭状态，请【框架科技】配合检查配置该密钥是否正确");
	/**
	 * 请求参数app_version不能为空
	 */
