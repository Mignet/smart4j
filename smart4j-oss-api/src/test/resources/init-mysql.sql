...
INSERT INTO `tsys_config` VALUES ('16', '微信分享-邀请理财师', 'wechat_share', 'wechat_share_link', 'http://mchannel.v5entapp.com/pages/user/register.html?recommendCode=%s&name=%s', null, '2015-10-13 14:30:46', '0');
INSERT INTO `tsys_config` VALUES ('17', '微信分享-邀请理财师', 'wechat_share', 'wechat_share_desc', '加入框架理财师，高收益产品自由代理，高比例佣金实时计算，更享丰厚推荐奖励！', null, '2015-10-13 17:28:37', '0');
INSERT INTO `tsys_config` VALUES ('18', '微信分享-邀请理财师', 'wechat_share', 'wechat_share_imgurl', 'http://mchannel.v5entapp.com/static/images/shareImg100_100.png', null, '2015-10-13 17:28:42', '0');
INSERT INTO `tsys_config` VALUES ('19', '微信分享-邀请理财师', 'wechat_share', 'wechat_share_title', '框架邀您成为理财师', null, '2015-10-13 17:28:46', '0');
INSERT INTO `tsys_config` VALUES ('20', '消息推送', 'pushmessage', 'pushmessage_partnerid', 'LHLC', '框架理财消息推送partnerid', '2015-10-13 17:53:23', '1');
INSERT INTO `tsys_config` VALUES ('21', '消息推送', 'pushmessage', 'pushmessage_rclcs_sign', 'RCLCS_SIGN', null, '2015-10-13 17:53:41', '0');
INSERT INTO `tsys_config` VALUES ('22', '邀请理财师推荐信息', null, 'rc_message_sign', '【小牛钱罐子】亲爱的罐主，您的理财师%s邀请您加入他的团队，晋级为框架理财师，既能赚收益又能赚佣金！限量邀请，马上加入吧 %s', null, '2015-10-13 18:02:40', '0');
INSERT INTO `tsys_config` VALUES ('23', '邀请理财师推荐信息', null, 'rc_message_anonymous', '【小牛钱罐子】亲爱的罐主，您已经成为钱罐子理财达人啦，我们推荐您晋级为框架理财师，既能赚收益又能赚佣金！限量开放，马上加入吧 %s', null, '2015-10-13 19:23:52', '0');
...
INSERT INTO `tsys_config` VALUES ('25', '微信分享-邀请客户', 'wechat_share_customer', 'wechat_share_customer_link', 'http://minvestor.v5entapp.com/pages/user/register.html?recommendCode=%s&name=%s', null, '2015-10-15 15:18:58', '0');
INSERT INTO `tsys_config` VALUES ('26', '微信分享-邀请客户', 'wechat_share_customer', 'wechat_share_customer_desc', '框架科技旗下创新理财平台！专业理财师贴身服务，年化收益高达11%！PICC全额保障账户安全！', '', '2015-10-13 17:28:37', '0');
INSERT INTO `tsys_config` VALUES ('27', '微信分享-邀请客户', 'wechat_share_customer', 'wechat_share_customer_imgurl', 'http://minvestor.v5entapp.com/static/images/shareImg100_100.png', '', '2015-10-13 17:28:42', '0');
INSERT INTO `tsys_config` VALUES ('28', '微信分享-邀请客户', 'wechat_share_customer', 'wechat_share_customer_title', '框架金服', '', '2015-10-13 17:28:46', '0');
...
INSERT INTO `tsys_config` VALUES ('38', '客户端配置', 'client_config', 'aboutme', 'http://mchannel.v5entapp.com/pages/agreement/about.html', '关于我们的链接地址', '2015-10-30 14:28:56', '1');
INSERT INTO `tsys_config` VALUES ('39', '客户端配置', 'client_config', 'question', 'http://mchannel.v5entapp.com/pages/questions/questions.html', '常见问题的链接地址', '2015-10-30 14:29:00', '1');
INSERT INTO `tsys_config` VALUES ('40', '客户端配置', 'client_config', 'showlevel', 'http://mchannel.v5entapp.com/pages/agreement/levelInterest.html', '查看等级职级介绍的链接地址', '2015-10-30 14:29:44', '1');
INSERT INTO `tsys_config` VALUES ('43', '客户端配置', 'client_config', 'rcintroduction', 'http://mchannel.v5entapp.com/pages/agreement/partnerService.html', '邀请理财师规则介绍的链接地址', '2015-10-30 14:31:28', '1');
...
INSERT INTO `tsys_config` VALUES ('47', '客户端配置', 'client_config', 'shareLogoIcon', 'http://mchannel.v5entapp.com/images/logo/80x80.png', '微信分享logo', '2015-10-30 14:47:11', '1');
INSERT INTO `tsys_config` VALUES ('48', '客户端配置', 'client_config', 'zfxy', 'http://mchannel.v5entapp.com/pages/agreement/payService.html', '支付协议地址', '2015-11-09 18:30:43', '1');
INSERT INTO `tsys_config` VALUES ('49', '客户端配置', 'client_config', 'question', 'http://minvestor.v5entapp.com/pages/questions/questions.html', '关于我们的链接地址', '2015-12-21 12:04:28', '2');
...
INSERT INTO `tsys_config` VALUES ('52', '客户端配置', 'client_config', 'shareLogoIcon', 'http://minvestor.v5entapp.com/images/logo/80x80.png', '微信分享logo', '2015-12-21 12:04:28', '2');
INSERT INTO `tsys_config` VALUES ('53', '客户端配置', 'client_config', 'wechatNumber', 'linghuijinfu', '微信公众号', '2015-12-21 12:04:28', '2');
INSERT INTO `tsys_config` VALUES ('54', '客户端配置', 'client_config', 'zfxy', 'http://minvestor.v5entapp.com/pages/agreement/payService.html', '支付协议地址', '2015-12-21 12:04:28', '2');
INSERT INTO `tsys_config` VALUES ('55', '客户端配置', 'client_config', 'aboutme', 'http://minvestor.v5entapp.com/pages/agreement/about.html', '关于我们的链接地址', '2015-12-21 12:05:18', '2');
INSERT INTO `tsys_config` VALUES ('57', '银行充值额度明细表', 'client_config', 'bankLimitDetail', 'http://minvestor.v5entapp.com/pages/agreement/chongzhixiane.html', '银行充值额度明细表', '2016-04-08 16:16:09', '1');
INSERT INTO `tsys_config` VALUES ('58', '客户端配置', 'client_config', 'bankLimitDetail', 'http://minvestor.v5entapp.com/pages/agreement/chongzhixiane.html', '银行充值额度明细表', '2016-04-08 17:58:27', '2');
...
INSERT INTO `tsys_config` VALUES ('67', '框架理财业务编码', null, 'lhlc_account_partnerId', '10004', '账户中心分配的业务编码', '2015-12-28 19:21:17', '0');
INSERT INTO `tsys_config` VALUES ('68', '账户中心分配给框架理财的签名key', null, 'lhlc_trans_md5_sign_key', '495256cf3723b9087bca1f830188', null, '2015-12-28 19:21:17', '0');
...
INSERT INTO `tsys_config` VALUES ('87', '投资者产品详情url', null, 'url_product_detail_investor', 'http://minvestor.v5entapp.com/pages/manage_finances/product_detail_credits.html', null, '2016-02-16 05:58:22', '0');
INSERT INTO `tsys_config` VALUES ('88', '通讯录-邀请客户', 'mail_invitation', 'mail_invitation_customer', 'Hi，我是理财师%s，邀您来框架金服投资，私享高收益产品和专业理财服务，限时送投资红包哦！马上注册吧 http://minvestor.v5entapp.com/pages/user/register.html?recommendCode=%s', '理财师邀请客户短信文案（通讯录方式)', '2016-02-26 10:49:55', '0');
INSERT INTO `tsys_config` VALUES ('89', '通讯录-邀请理财师', 'mail_invitation', 'mail_invitation_lcs', 'Hi，我是%s，推荐您加入框架理财师，高收益产品自由代理，高比例佣金实时计算，限量推荐哦，点击注册 http://mchannel.v5entapp.com/pages/user/register.html?recommendCode=%s', '理财师推荐理财师短信文案（通讯录方式)', '2016-02-26 10:49:57', '0');
INSERT INTO `tsys_config` VALUES ('90', '客户端配置', 'client_config', 'userService', 'http://mchannel.v5entapp.com/pages/agreement/userService.html', '理财师用户协议', '2016-03-03 16:05:53', '1');
INSERT INTO `tsys_config` VALUES ('91', '客户端配置', 'client_config', 'userService', 'http://minvestor.v5entapp.com/pages/agreement/userService.html', '金服用户协议', '2016-02-29 17:46:27', '2');
INSERT INTO `tsys_config` VALUES ('92', '通讯录-客户邀请客户', 'mail_invitation', 'mail_customer_invitation_customer', 'Hi，我是（%s），快来框架金服和我一起投资，私享高收益产品加专业理财师服务！马上注册吧 http://minvestor.v5entapp.com/pages/user/register.html?recommendCode=%s', '客户邀请客户短信文案（通讯录方式）', '2016-03-09 15:01:29', '0');
INSERT INTO `tsys_config` VALUES ('93', '消息推送', 'pushmessage', 'pushmessage_partnerid', 'LHJF', '框架金服消息推送partnerid', '2015-10-14 05:53:23', '2');
INSERT INTO `tsys_config` VALUES ('94', '短信partnerid', '', 'send_vcode_partnerid', 'LHJF', null, '0000-00-00 00:00:00', '2');
INSERT INTO `tsys_config` VALUES ('95', '消息推送', 'pushmessage', 'pushmessage_cregister', '欢迎加入框架金服！您的专属理财师已准备好为您服务啦，投资问题随时互动，轻松开启专业理财！关注官方微信linghuijinfu还可以“骚扰”框架君哦', '用户注册成功', '2016-03-21 01:06:46', '2');
...
INSERT INTO `tsys_config` VALUES ('100', '消息推送', 'pushmessage', 'pushmessage_lregister', '亲爱的理财师，欢迎加入框架!现在就去邀请客户注册【框架金服】并投资吧，超高佣金等着你哦~', '理财师 用户（理财师自己）注册成功', '2016-03-21 02:27:47', '1');
...
INSERT INTO `tsys_config` VALUES ('102', '消息推送', 'pushmessage', 'pushmessage_lassigancustomer', '恭喜您，框架平台为您分配了一位新客户%s，快去为Ta制定投资计划吧', '理财师   平台分配客户', '2016-03-21 02:31:33', '1');
...
INSERT INTO `tsys_config` VALUES ('114', '推荐产品名称', 'recommend', 'recommend_product_name', '框架宝180天期', '推荐产品名称', '2016-04-29 10:13:54', '0');
INSERT INTO `tsys_config` VALUES ('115', '推荐产品名称1', 'recommend1', 'recommend_product_name1', '框架宝180天期1', '推荐产品名称', '2016-04-29 10:13:54', '0');
INSERT INTO `tsys_config` VALUES ('127', '框架用户中心签名Key', 'userCenter', 'lh_userCenter_signKey', 'S5Yn9H5qk0Yf1ZhwGum3SdwnVZ7fMAUD', '框架用户中心签名KEY', '2016-05-12 21:55:02', '0');
...
INSERT INTO `tsys_config` VALUES ('143', '客户端配置', 'client_config', 'saleUserLevelUrl', 'http://mchannel.v5entapp.com/pages/mine/mine_level.html', '职级界面', '2016-05-16 16:31:56', '1');
