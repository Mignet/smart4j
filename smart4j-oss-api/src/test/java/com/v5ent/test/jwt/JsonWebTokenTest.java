...
//		SecureRandom random = new SecureRandom();
		byte[] sharedSecret = StringUtils.getBytesUtf8("https://www.v5ent.com");
...
//		random.nextBytes(sharedSecret);
		...
		claimsSet.setIssuerClaim("https://www.v5ent.com");
		...
		assertEquals("https://www.v5ent.com", signedJWT.getJWTClaimsSet().getIssuerClaim());
