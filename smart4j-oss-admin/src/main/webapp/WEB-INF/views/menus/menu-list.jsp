...
<!-- <link rel="stylesheet" type="text/css" href="app/css/v5ent.tables.css"  /> -->
<script type="text/javascript" src="assets/plugins/data-tables/js/jquery.dataTables.min.js"  ></script>
<script type="text/javascript" src="assets/plugins/handlebars/handlebars-4.0.5.js"  ></script>
<script type="text/javascript" src="app/js/jquery.v5ent.js"></script>
...
<div id="main-menus" class="container-fluid">
    ...
    <script type="text/javascript">
       ...
       var menusDb= $("#JmenuList").v5entTable({
            formats:{
    ...
    <script type="text/v5ent-template" id="template-search">
        <form>
            <div class="row">
                <div class="col-sm-2">
